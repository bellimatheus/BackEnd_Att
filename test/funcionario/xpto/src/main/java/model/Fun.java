...
public class Fun {
	...
	public Fun(String nomeCompleto, String dataDesligamento, Float ultimoSalario) {
	...
	public void setUltimoSalario(Float ultimoSalario) {
		this.ultimoSalario = ultimoSalario;
	}
